...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_DARKONAH)
extern struct cpufreq_governor cpufreq_gov_darkonah;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_darkonah)
