...
make ARCH=arm CROSS_COMPILE=~/linaro/bin/arm-linaro-linux-androideabi- $DEFCONFIG
make -j32 ARCH=arm CROSS_COMPILE=~/linaro/bin/arm-linaro-linux-androideabi-
...
cd ~/redkancut
rm *.zip
zip -r9 redkancut_cancro-MIUI-v8.1.zip * -x README redkancut_cancro-MIUI-v8.1.zip
